    ...
    <div>
      <section id="why-us" className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 font-knockout">Why Choose Jack Daniels</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <Award className="mx-auto mb-4 text-yellow-500" size={48} />
              <h3 className="text-xl font-semibold mb-2 font-knockout">Premium Selection</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 font-knockout">Fast Delivery</h3>
              <p className="text-gray-600">Quick and reliable delivery to your doorstep.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <Clock className="mx-auto mb-4 text-yellow-500" size={48} />
              <h3 className="text-xl font-semibold mb-2 font-knockout">24/7 Support</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 font-knockout">Tasting Events</h3>
